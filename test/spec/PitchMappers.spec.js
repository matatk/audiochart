...
(function() {
  ...
  describe('FrequencyPitchMapper', function() {
    ...
    it('maps from input data to a frequency (1)', function() {
      var fm;
    ...
    it('maps from input data to a frequency (2)', function() {
      var fm;
    ...
    it('maps from input data to a frequency (3)', function() {
      var fm;
    ...
    it('maps from input data to a frequency (4)', function() {
      var fm;
    ...
    it('maps from input data to a frequency (5)', function() {
      var fm;
