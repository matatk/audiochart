...
ShortFakeDataWrapper = (function(superClass) {
  function ShortFakeDataWrapper() {
    return DataWrapper.constructor.apply(this, arguments);
  }
  ...
  return describe(message, function() {
    ...
    beforeEach(function() {
      ...
      if (use_visual_callback) {
        ...
        player = new ac.Player(test_duration, fake_data, fake_mapper, fake_sounder, fake_visual_callback);
      } else {
        player = new ac.Player(test_duration, fake_data, fake_mapper, fake_sounder);
      }
    });
