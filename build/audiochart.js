...
(function() {
  var AudioChart, DataSource, DataWrapper, FrequencyPitchMapper, GoogleDataWrapper, NotePitchMapper, PitchMapper, Player, Sounder, WebAudioSounder, _ref,
  ...
  NotePitchMapper = (function(_super) {
    ...
    function NotePitchMapper() {
      _ref = NotePitchMapper.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  Sounder = (function() {
    ...
    Sounder.prototype.start = function(opt_offset) {};

    Sounder.prototype.stop = function(opt_offset) {};
  ...
  WebAudioSounder = (function(_super) {
    ...
    WebAudioSounder.prototype.stop = function(opt_offset) {
      if (opt_offset == null) {
        opt_offset = 0;
      }
  ...
  Player = (function() {
    ...
    Player.prototype.play = function() {
      var callback_play, series_length, series_max_index,
        _this = this;
      ...
      callback_play = function() {
        ...
        for (i = _i = 1; 1 <= series_max_index ? _i <= series_max_index : _i >= series_max_index; i = 1 <= series_max_index ? ++_i : --_i) {
          _this.sounder.frequency(_this.data_source.series_value(0, i), _this.interval * i);
        }
      };
      setTimeout(callback_play, this.interval);
      setTimeout((function() {
        return _this.sounder.stop();
      }), series_length * this.interval);
    };
